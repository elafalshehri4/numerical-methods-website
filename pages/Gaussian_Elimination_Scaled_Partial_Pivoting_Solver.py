...
import math
CONFIG = {'method_id': 'scaled_pivoting',
 'title': 'Scaled Partial Pivoting Solver',
 'label': 'SCALED PARTIAL PIVOTING TOOL',
 'description': 'Solve a square linear system using scale-aware row selection, forward elimination, and back '
                'substitution.',
 ...
 'conditions': ['The coefficient matrix must be square.',
                ...
                'A valid scaled pivot must exist at every elimination stage.'],
 'formula': 'r_i=\\frac{|a_{ik}|}{s_i},\\qquad s_i=\\max_j|a_{ij}|',
 'defaults': {'A': [[0.001, 1.0], [1.0, 1.0]], 'b': [1.001, 2.0]}}
