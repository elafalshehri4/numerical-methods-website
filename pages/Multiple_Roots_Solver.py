CONFIG = {'method_id': 'multiple',
 'title': 'Multiple Roots Solver',
 'label': 'MULTIPLE ROOTS METHOD TOOL',
 'description': 'Enter a differentiable function, a starting value, and the known multiplicity to refine a '
                'repeated root.',
 'lesson': 'Multiple_Roots_Method',
 'quiz': 'Multiple_Roots_Quiz',
 'footer': 'Multiple Roots Solver • Root Finding',
 'default_eq': '(x - 2)**3',
 'inputs': [('x0', 'Initial approximation x₀', 3.0), ('multiplicity', 'Root multiplicity m', 3)],
 'conditions': ['The multiplicity must be a positive integer.',
                'The derivative is calculated automatically.',
                'The starting value should be near the repeated root.'],
 'formula': "x_{n+1}=x_n-m\\frac{f(x_n)}{f'(x_n)}"}
