...
import math
CONFIG = {'method_id': 'gauss_jordan',
 'title': 'Gauss-Jordan Solver',
 'label': 'GAUSS-JORDAN METHOD TOOL',
 'description': 'Reduce an augmented matrix to reduced row echelon form and read the linear-system solution '
                'directly.',
 'lesson': 'Gauss_Jordan_Method',
 'quiz': 'Gauss_Jordan_Quiz',
 'footer': 'Gauss-Jordan Solver • Linear Systems',
 'conditions': ['The matrix and vector dimensions must agree.',
                'A unique solution requires a pivot in every variable column.',
                'Row exchanges are used when the current pivot is zero or extremely small.'],
 'formula': 'R_k\\leftarrow\\frac{R_k}{a_{kk}},\\qquad R_i\\leftarrow R_i-a_{ik}R_k',
 'defaults': {'A': [[2.0, 1.0], [1.0, -1.0]], 'b': [5.0, 1.0]}}
