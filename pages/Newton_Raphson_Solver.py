CONFIG = {'method_id': 'newton',
 'title': 'Newton-Raphson Solver',
 'label': 'NEWTON-RAPHSON METHOD TOOL',
 'description': 'Enter a differentiable function and one starting value to approximate a root using '
                'tangent-line updates.',
 'lesson': 'Newton_Raphson_Method',
 'quiz': 'Newton_Raphson_Quiz',
 'footer': 'Newton-Raphson Solver • Root Finding',
 'default_eq': 'x**3 - x - 2',
 'inputs': [('x0', 'Initial approximation x₀', 1.5)],
 'conditions': ['The derivative is calculated automatically.',
                'The derivative must not be zero or extremely small during iteration.',
                'A starting value near the desired root improves reliability.'],
